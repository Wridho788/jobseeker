    ...
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-start justify-center'>
      <div>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7'>
          ...
          quisquam atque quis modi cum vitae totam, ullam esse labore sit rem
          dolores maiores praesentium illo animi amet accusantium numquam?
        </p>
      </div>
      <div className='grid'>
      ...
      <div className='grid '>
        ...
        <div>
          <small className='text-[14px] text-white'>wridho246@gmail.com</small>
